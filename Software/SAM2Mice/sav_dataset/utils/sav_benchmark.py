...
if __name__ == "__main__":
    ...
    # gt_roots = ["/mnt/nas00/LAR/dataset/sam2_train_data/PICO_five_mouse_dataset_new/Annotations"]
    # mask_roots = ["/mnt/nas00/LAR/dataset/sam2_train_data/benchmark/sam2.1_base_plus"]
    # gt_roots = ["/mnt/nas00/LAR/dataset/sam2_train_data/PICO_five_mouse_dataset_new/Annotations"]
    # mask_roots = ["/mnt/nas00/LAR/dataset/sam2_train_data/benchmark/sam2.1_base_plus_finetuned"]
    gt_roots = [
                "/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_train/Annotations", 
                "/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_train/Annotations"]
    mask_roots = [
                "/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_vis/before_finetune",
                "/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_vis/after_finetune",
                  ]
