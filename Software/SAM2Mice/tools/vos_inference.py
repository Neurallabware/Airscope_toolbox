...
def main():
    ...
    parser.add_argument(
        "--sam2_checkpoint",
        type=str,
        # default="./checkpoints/sam2_base_WT_wheel_finetuned.pt",
        default="./checkpoints/sam2_base_148d_fed_finetuned.pt",
        # default="./checkpoints/sam2_base_five_mouse_finetuned.pt",
        help="path to the SAM 2 model checkpoint",
    )
    parser.add_argument(
        "--base_video_dir",
        type=str,
        default="/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_train/JPEGImages" ,
        help="directory containing videos (as JPEG files) to run VOS prediction on",
    )
    parser.add_argument(
        "--input_mask_dir",
        type=str,
        default="/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_train/Annotations",
    ...
    parser.add_argument(
        "--output_mask_dir",
        type=str,
        default="/mnt/nas01/LAR/pico/Experiments/hierarchy/SAM_train/dataset/148d/fed_vis/after_finetune",
